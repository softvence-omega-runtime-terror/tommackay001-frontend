    ...
    <div className="flex flex-col gap-8 font-inter">
      ...
      <div className="space-y-2">
        ...
        <p className="text-sm lg:text-base font-medium text-[#535862]">
          View and manage all your communications with providers.
        </p>
      </div>
      ...
      <div className="flex flex-col items-center justify-center min-h-[400px] lg:min-h-[500px] bg-white rounded-2xl p-6 lg:p-12">
        <div className="flex flex-col items-center gap-6 text-center max-w-sm">
          <div className="w-16 h-16 lg:w-20 lg:h-20 bg-gradient-to-br from-blue-100 to-indigo-100 rounded-full flex items-center justify-center">
          ...
          <div className="space-y-3">
            ...
            <p className="text-sm lg:text-base text-[#535862] leading-relaxed">
              ...
              providers about your tasks and requirements.
            </p>
          </div>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 lg:gap-6">
        <div className="bg-white border border-[#e9eaeb] rounded-xl p-4 lg:p-6">
          ...
          <p className="text-xs lg:text-sm text-[#535862]">
            Communicate directly with providers about task specifications and
            requirements.
          </p>
        </div>
        ...
        <div className="bg-white border border-[#e9eaeb] rounded-xl p-4 lg:p-6">
          ...
          <p className="text-xs lg:text-sm text-[#535862]">
            Access all your past conversations and task discussions.
          </p>
        </div>
        ...
        <div className="bg-white border border-[#e9eaeb] rounded-xl p-4 lg:p-6">
          ...
          <p className="text-xs lg:text-sm text-[#535862]">
            Get real-time notifications about provider progress and task
            updates.
          </p>
        </div>
      </div>

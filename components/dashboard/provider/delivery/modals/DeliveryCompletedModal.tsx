...
export default function DeliveryCompletedModal({ task, open, onClose }: Props) {
        ...
        <div className="flex flex-col max-h-[90vh]">
          <div className="px-6 pt-6 pb-4 border-b border-[#e9eaeb] shrink-0 ">
            ...
            <div className="flex justify-end mt-3">
              <span className="text-[10px] font-semibold bg-seco text-primary px-2.5 py-0.5 rounded-full border border-[#6CE9A6]">
                COMPLETED{" "}
              </span>
            </div>
          </div>

        ...
        <div className="flex flex-col max-h-[90vh]">
          <div className="px-4 md:px-6 pt-4 md:pt-6 pb-3 md:pb-4 border-b border-[#e9eaeb] shrink-0 ">
            ...
            <div className="flex justify-end mt-2 md:mt-3">
              <span className="text-[8px] md:text-[10px] font-semibold bg-[#ECFDF3] text-primary px-2 md:px-2.5 py-0.5 rounded-full border border-[#6CE9A6]">
                AVAILABLE
              </span>
            </div>
          </div>
          ...
          <div className="shrink-0 px-4 md:px-6 pb-4 md:pb-6 pt-3 md:pt-4 flex justify-between border-t border-[#e9eaeb] gap-3">
            ...
            <button
              ...
              className="flex-2 cursor-pointer bg-secondary max-w-100 hover:bg-[#d94118] text-white font-bold text-xs md:text-sm py-3 md:py-3.5 rounded-xl transition-colors flex items-center justify-center gap-2 tracking-wide"
            >

...
const FinalCTA = () => {
  return (
    <section className="py-12.5 px-6 ">
      <div className="max-w-330 mx-auto">
        <div className="bg-[#FFF1E9]! rounded-2xl p-12 flex flex-col gap-5 items-center text-center relative overflow-hidden">
          ...
          <h2 className="relative z-10 font-sora font-semibold text-[48px] leading-15 tracking-[-0.96px] text-secondary">
            Ready to grow your authority?
          </h2>

          <p className="relative z-10 font-inter font-normal text-xl leading-7.5 text-gray-900 max-w-185.25">
          ...
          <div className="relative z-10 flex gap-5 items-center mt-4 flex-wrap justify-center">
            ...
            <Link
              href="/how-it-works"
              className="flex gap-2.5 items-center justify-center bg-white hover:bg-brand-orange-700 border border-[#FEA369]! text-secondary px-7.5 py-3.5 rounded-2xl font-semibold font-inter text-base leading-6 transition-all"
            >
